...
namespace ProTips.Scripts.Behaviors
{
    public class TooltipTrigger : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, ISelectHandler, IDeselectHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        {
            // When a tooltip trigger object is disabled or destroyed, close any open tooltip associated with it
        ...
        public string GetText(string parameterName)
        {
            ...
            // Check to see if we find a matching field. If so, return its current text value.
